...
const Base_Url = "https://spendly-qhpk.onrender.com";
...
export const useAuthStore = create((set) => ({
  ...
  checkAuth: async () => {
    ...
    try {
      const res = await axios.get(`${Base_Url}/api/users/checkAuth`);
  ...
  deleteUser: async (email) => {
    try {
      const res = await axios.delete(`${Base_Url}/api/users/deleteUser/${email}`);
